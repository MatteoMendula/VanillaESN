...
def run_experiment(folder, reservoir, readout, run_with_ip, features_train, target_train, features_test1, target_test1, features_test2, target_test2, RC_size, accuracies_test1, f1_scores_test1, accuracies_test2, f1_scores_test2, training_latencies, inference_latencies1, inference_latencies2):
    ...
    readout = readout.fit(train_states[warmup:], target_train[warmup:])
...
for RC_size in RC_sizes:
    ...
    _folder = f"{folder}/RC_size_{RC_size}"
    run_experiment(_folder, reservoir, readout, run_with_ip, features_scaled_train, target_train, features_scaled_test1, target_test1, features_scaled_test2, target_test2, RC_size, accuracies_test1, f1_scores_test1, accuracies_test2, f1_scores_test2, training_latencies, inference_latencies1, inference_latencies2)

plot_1_series(folder, RC_sizes, training_latencies, "Training Latency", "RC_size", "Latency", "Training Latency")
plot_1_series(folder, RC_sizes, inference_latencies1, "Inference Latency Test1", "RC_size", "Latency", "Inference Latency")
plot_1_series(folder, RC_sizes, inference_latencies2, "Inference Latency Test2", "RC_size", "Latency", "Inference Latency")
plot_1_series(folder, RC_sizes, accuracies_test1, "Accuracy Test1", "RC_size", "Accuracy", "Accuracy")
plot_1_series(folder, RC_sizes, accuracies_test2, "Accuracy Test2", "RC_size", "Accuracy", "Accuracy")
plot_1_series(folder, RC_sizes, f1_scores_test1, "F1 Test1", "RC_size", "F1", "F1")
plot_1_series(folder, RC_sizes, f1_scores_test2, "F1 Test2", "RC_size", "F1", "F1")